...
#   3. Initialize git repo and add GitHub remote if not already done

set -e  # Exit on error

echo "======================================"
echo "Creating GitHub Issues for Qualtrics SDK"
echo "======================================"
echo ""
...
if ! git rev-parse --git-dir &> /dev/null; then
    ...
    echo "Initialize with: git init && git remote add origin <github-url>"
    exit 1
fi
...
# Issue 1: Embedded Data Support
echo "Creating Issue #1: Embedded Data Support..."
gh issue create \
...
EOF
    ...
    --label "enhancement,v0.2.0" \
    --milestone "v0.2.0" 2>/dev/null || echo "Note: Milestone v0.2.0 may need to be created first"

echo "✅ Issue #1 created"
echo ""

# Issue 2: Randomization Support
echo "Creating Issue #2: Randomization Support..."
gh issue create \
...
EOF
    ...
    --label "enhancement,v0.2.0" \
    --milestone "v0.2.0" 2>/dev/null

echo "✅ Issue #2 created"
echo ""

# Issue 3: Conditional Display Logic
echo "Creating Issue #3: Conditional Display / Display Logic..."
gh issue create \
...
# Issue 4: Response Management
echo "Creating Issue #4: Response Management..."
gh issue create \
...
EOF
    ...
    --milestone "v0.4.0" 2>/dev/null || echo "Note: Milestone v0.4.0 may need to be created first"
...
echo "======================================"
echo ""
echo "View issues with: gh issue list"
echo "View a specific issue: gh issue view <number>"
echo ""
echo "Note: If milestones don't exist yet, create them on GitHub:"
echo "  - Repository → Issues → Milestones → New milestone"
echo "  - Create 'v0.2.0' and 'v0.4.0' milestones"
echo "  - Then run: gh issue edit <number> --milestone 'v0.2.0'"
